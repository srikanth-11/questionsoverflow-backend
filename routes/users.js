...
router.post('/register', async (req, res) => {
   try {
      ...
      if (user) {
         ...
         const mailSubject = "Registration for  Questionsoverflow app";
...
router.post('/forgot-password', async (req, res) => {
   try {
      ...
      if (user) {
         ...
         const mailSubject = 'Reset Password for  Questionsoverflow app';
         const mailBody = `<div>
...
router.put('/reset', async (req, res) => {
   try {
      ...
      if (user) {
         ...
         const mailService = new MailService();
         const mailSubject = 'Successfully changed Password for  Questionsoverflow app';
         const mailBody = `<div>
